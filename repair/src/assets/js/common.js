...
export var Config = function() {
    var t = {
        ...
        user_info: {
            avatar: "https://test.e-shequ.com/baofang/weixin/static/images/logo.jpg",
            nickname: "游客",
            levelname: "普通会员"
        },
        user_level:{
        ...
        coupon:{
            seedImg:"https://test.e-shequ.com/baofang/weixin/static/img/banner/banner_market_shuiguo.jpg"
        }
    },
    e = {};
    return e.C = function(e) {
...
function toRegisterAndBack(){
    ...
    location.href=MasterConfig.C('basePageUrl')+"home/indexdl.html?start=123#/register?comeFrom="+encodeURIComponent(n);
}
