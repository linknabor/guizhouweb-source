        ...
        <div  class="category lite-divider" v-show="threadCategory>=2">
             <div class="category_main">
                 <div  class="category_sub_main fl">
                   ...
                   <img class="category_img" src="../../assets/images/butler/img_repair_60x60.png" v-show="threadCategory!=2"/>
                    <img class="category_img_hide" src="../../assets/images/butler/img_repair_60x60_selected.png" v-show="threadCategory==2"/> 
                ...
                <div  class="category_sub_main fl">
                    ...
                    <img class="category_img" src="../../assets/images/butler/img_education_60x60.png" v-show="threadCategory!=3"/>
                    <img class="category_img_hide" src="../../assets/images/butler/img_education_60x60_selected.png" v-show="threadCategory==3"/>
...
export default {
   ...
   created() {
     ...
     // 请求接口获取 后台返回的 微信配置项
        ...
        vm.receiveData.wxconfig(vm,wx,['chooseImage','previewImage','uploadImage','downloadImage','getLocalImgData'],url);
       this.wxdata()
