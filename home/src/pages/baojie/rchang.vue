<template>
   <div class="bannerse">
        ...
        <div class="suggest">
    		...
    		<div class="example">
    			<img src="../../assets/images/baojie/xiyidesc.png" />
    		</div>
    	</div>
        ...
        <div class="remind">
			<div class="title2">
				<span>
                    <img src="../../assets/images/baojie/icon_wenxintishi_07.png" />
                    温馨提示
                </span>
			</div>
...
export default {
   ...
   methods: {
        ...
        //立即预约
        gotoPay() {
            if(vm.common.checkRegisterStatus()&&vm.item.id){
               window.location.href=vm.config.home_baojie.url2+'?item='+vm.item.id;
            }
        },
