   ...
   data () {
       return {
             orderimg:[
               ...
               {name:'98元鲜花包月',url:src18},
               {name:'混合鲜花包月',url:src19},
               ...
               {name:'鲜花',url:'http://7xnqht.com2.z0.glb.qiniucdn.com/Ft938gqke4n1WnweKeX1lxCdTMas'},
                ...
                if(vm.res.success) {
                    ...
                    if(vm.order == null || vm.order.id == null){
                         MessageBox.confirm('获取订单补充信息信息失败，返回服务首页！').then(action => {
                             location.href=this.config.footer.home;
                         }).catch(err => {
                            if(err == 'cancel') {
