<template>
   <div id="word">
        ...
        <div v-show="threads_count==0">
		    <img class="adimg" src="../../assets/images/house/bg_nohouse.png"/>
	    </div>
        <!-- 评论  -->
        <div class=" p15 " style="border-bottom: 2px solid #d4cfc8;"  v-for="thread in threads">
             ...
             <div class="ov pt15 pb15 fs13" style="color: #3b3937;word-break: break-all;word-wrap: break-word" @click="gotoDetail(thread.threadId)">{{thread.threadContent}}</div>   
            <!-- 图片 -->
            ...
            <div class="fs13" style="color: #a6937c; line-height: 23px; width: 100%;">
                ...
                <div class="fr pr15 comment" style="text-align: right;" @click="gotoDetail(thread.threadId)" >
                    <img style="width: 13px; height: 13px;" src="../../assets/images/butler//icon_comment_gray.png"/>&nbsp;{{thread.commentsCount}}
                </div>
            </div>
        </div>
